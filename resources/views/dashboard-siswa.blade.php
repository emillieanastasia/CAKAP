    ...
    <div class="flex flex-col lg:flex-row gap-4 w-full">
        ...
        <div class="w-full lg:flex-[1] flex-shrink-0">
            <div class="bg-[#00537A] p-4 rounded-[16px] shadow-xl border border-[#A8E8F9]/10 sticky top-4 h-full">
                ...
                <a href="{{ route('edit.profil') }}" class="absolute top-2 right-4 bg-gold hover:bg-yellow-500 text-[#013C58] font-bold p-2 rounded-full shadow-lg shadow-gold/10 transition-all transform hover:-translate-y-1 hover:shadow-gold/30" title="Edit Profil">
