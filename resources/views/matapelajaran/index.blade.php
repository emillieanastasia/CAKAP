    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-4">
        <div>
            <h1 class="text-2xl font-bold text-white">
                Data <span class="text-lightgold">Mapel</span>
            </h1>
            <p class="text-sky text-xs mt-0.5">Kelola mata pelajaran.</p>
        </div>
...
<form method="GET" action="{{ route('matapelajaran.index') }}" class="mb-4">
    ...
    {{-- TABLE --}}
    <div class="bg-teal rounded-2xl shadow-xl border border-sky/10 overflow-hidden mb-4">
        <div class="overflow-x-auto">
            <table class="w-full text-center border-collapse">
                <thead class="bg-navy text-sky uppercase text-[10px] font-bold tracking-wider">
                    <tr>
                        <th class="py-3 px-4 text-center">No</th>
                        <th class="py-3 px-4 text-center">Nama Mata Pelajaran</th>
                ...
                <tbody class="divide-y divide-sky/10 text-xs">
                        ...
                        <td class="px-4 py-2">
                            <div class="flex justify-center items-center gap-1.5">
                                ...
                                <a href="{{ route('matapelajaran.edit', $mapel->id) }}" 
                                    class="inline-block bg-gold hover:bg-lightgold text-navy font-bold px-3 py-1.5 rounded-lg text-xs shadow transition-all transform hover:-translate-y-0.5">
                                ...
                                {{-- DELETE BUTTON --}}
                                <form action="{{ route('matapelajaran.destroy', $mapel->id) }}" 
                                    ...
                                    <button type="submit"
                                        ...
                                        class="tombol-hapus bg-red-600 hover:bg-red-700 text-white font-bold px-3 py-1.5 rounded-lg text-xs shadow transition-all transform hover:-translate-y-0.5">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-6 py-8 text-center text-sky/50 italic text-xs">
        ...
        {{-- UPDATE: Menampilkan Link Pagination --}}
    @if ($matapelajaran->hasPages())
    <div class="p-3 border-t border-sky/10 bg-teal">
...
document.querySelectorAll('.form-hapus').forEach(form => {
    form.addEventListener('submit', function(e) {
        ...
        Swal.fire({
            title: 'Hapus Data?',
            text: "Mata pelajaran \"" + nama + "\" akan dihapus permanen.",
            icon: 'warning',
            background: '#002b40',
            color: '#fff',
